package com.example.springbootxxljob.model;
...
public class XxlJobInfo implements Serializable {
	...
	public static XxlJobInfo taskJob(Integer jobGroup, String name, String operate, String frequency, String handler, String param, Integer status) {

		/**
		 * 获取执行器 ID，任务执行必需有对应的执行器 ID
		 */
		 ...
		 * 调度配置（调度时间）
		 */
		xxlJobInfo.setScheduleConf(frequency);
